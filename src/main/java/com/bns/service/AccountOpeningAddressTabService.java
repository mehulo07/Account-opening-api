...
public class AccountOpeningAddressTabService {
	...
	public AccountOpeningAddressTab updateAccountOpeningAddressTab(Long accountOpeningAddressTabId,
		...
		AccountOpeningAddressTab accountOpeningAddressTab1 = accountOpeningAddressTabRepository.findById(accountOpeningAddressTabId)
		        		.orElseThrow(() -> new ResourceNotFoundException("Account Opening AddressTabIe not found for this id :: " + accountOpeningAddressTabId));
		 	
			long businessinfoid=accountOpeningAddressTab.getAccountOpeningBusinessInfo().getAccountOpeningBusinessInfoId();
			...
			accountOpeningAddressTab1.setStateTab(accountOpeningAddressTab.getStateTab());
		        ...
		        final AccountOpeningAddressTab updatedAccountOpeningAddressTab = accountOpeningAddressTabRepository.save(accountOpeningAddressTab1);
