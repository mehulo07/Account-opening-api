...
@Entity
@Table(name="Account_Opening_Reg_Info_Tab")
public class AccOpeningReg implements Serializable {
	...
	public AccOpeningReg() {
		
			}
	

	public AccOpeningReg(int accountOpeningRegInfoId, String firstName, String surName, String regPosition,
